...
INT wifi_hal_startScan(wifi_radio_index_t index, wifi_neighborScanMode_t scan_mode, INT dwell_time, UINT num, UINT *chan_list)
{
    ...
    return (nl80211_start_scan(interface, NL80211_SCAN_FLAG_FLUSH | NL80211_SCAN_FLAG_HIGH_ACCURACY	| NL80211_SCAN_FLAG_AP, freq_num, freq_list, dwell_time, 1, ssid_list) == 0) ? RETURN_OK:RETURN_ERR;
}
